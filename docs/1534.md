...
> 原文:[https://codescracker.com/c/program/c-anagram-program.htm](https://codescracker.com/c/program/c-anagram-program.htm)
...
![c anagram program](../Images/a9a082d1cc24370e0d4e0abd5cabc2e0.png)

现在提供任意两个字符串，比如 social 和 soliat，作为输入，并按 ENTER 键查看输出，如下面给出的示例运行的第二个快照所示:

![c program to check anagram or not](../Images/6d8caf1e94d94c18af3841495033db76.png)

让我们采取另一个样本运行，并检查另外两个字符串，说超级和上层。以下是示例运行的最终快照:

![c check anagram or not](../Images/251591dff31c945d4243451984e54a9f.png)
...
![c check string anagram not](../Images/d4ba94054c73320e2dc9187fc94c66da.png)
