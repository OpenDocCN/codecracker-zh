...
> 原文:[https://codescracker . com/c/program/c-program-find-greatest-of-three-numbers . htm](https://codescracker.com/c/program/c-program-find-greatest-of-three-numbers.htm)
...
![c program find biggest of three numbers](../Images/f678f3f68a6838016accdc14103bcefa.png)

提供任意三个数字，如 **3** 、 **1** 和 **2** 。按`ENTER`键查看样品运行的第二张快照中给出的最大数字:

![c program find largest of three numbers](../Images/63c4c28878d3c41220868493e0acef57.png)

下面是另一个运行示例:

![c program find greatest in three numbers](../Images/22f4addf25fd06b7d2c8f2c940a2ce9b.png)

下面是上述程序的最后一次运行示例:

![c print largest of three numbers](../Images/04a424b61f613999106820048e9106fc.png)
...
![largest of three number ternary operator](../Images/16f26a0079c7989f1659afd9f54ec323.png)

现在提供任意三个数字作为输入，比如说 **12** 、 **23** 和 **11** ，然后按`ENTER`查看以下输出:

![largest of three using ternary operator c](../Images/7eced009be7aa2557e280e29029f07cf.png)
...
![c find largest of three using function](../Images/c8a5196d7450cb06118d7c50ffb532e9.png)
