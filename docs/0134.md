...
> 原文:[https://codescracker . com/python/program/python-program-calculate-average-of-numbers . htm](https://codescracker.com/python/program/python-program-calculate-average-of-numbers.htm)
...
![calculate average of numbers python](../Images/c945a371de239a70980bc9245165c347.png)

现在提供输入说 **5** 作为 **n** 的值，然后输入任意五个数字说 **12、43、54、10** 和 **23** 一个接一个 。按`ENTER`键查找并打印给定数字的平均值，如下图所示:

![find average of numbers python](../Images/436174eb5a1eadacc59d9a284ac27af9.png)
...
![python calculate average of numbers](../Images/1d00c5afb3f5eee7de521d3d4e589bd1.png)
...
![find average of n numbers python](../Images/8cf0eb085b4c0f6875d8d9b05ace6262.png)
