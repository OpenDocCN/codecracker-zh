...
> 原文:[https://codescracker . com/CPP/program/CPP-program-print-star-pyramid-patterns . htm](https://codescracker.com/cpp/program/cpp-program-print-star-pyramid-patterns.htm)

在这篇文章中，您将学习并获得使用星号(*)、数字和字母打印多种类型图案的代码，以创建金字塔、三角形等。比如形状。以下是 C++中的模式程序列表:
...
![C++ program print patterns](../Images/8e27e53bddb2a2cf88d1f24e39bbea2c.png)
...
![print pattern in C++ Programming](../Images/9375093a17df460bb212b48f6eb04b80.png)
...
![C++ program print star pattern](../Images/d4af2fe69d740a4673bc859a60e67aed.png)
...
![pyramid pattern of stars c++](../Images/47ce3cb36e9d99f3674aa49da33b9c68.png)
...
![c++ program to print patterns](../Images/c0beff7f0d030763312e1e08540ffb05.png)
...
![c++ program print pattern of numbers and stars](../Images/2067776465998833ae4d921f822d8f66.png)

现在提供输入，比如说 **1** 作为你的选择，如果你想打印半个星星金字塔，这里是提供 1 作为输入并按下`ENTER`键后的 示例输出:

![c++ print pyramid of stars](../Images/8e18b0b2dc8cb5701ce8d14571ceb758.png)

如您所见，半金字塔被打印出来，菜单再次显示出来。现在你可以进一步操作，否则如果你想跳过或退出，然后键入 5 或输入 5，以四种方式退出打印星星图案的程序。这是样本运行的另一个快照。此快照显示了所有选项的使用情况:

![c++ print pattern of stars](../Images/3db263de95dbfb1726aac0ea9561ba13.png)
...
![print star pattern in C++ Programming](../Images/95772972a6ff289501041ec9a832de4c.png)
...
![C++ program print pattern using looping](../Images/4ebd6f7524a7bcdf09b76c2b74e10498.png)
...
![looping in C++ Programming](../Images/0403e22b004163d869848e91a70eaa6a.png)

## C++打印数字模式

这个程序打印数字模式(自然数)。这个数字模式看起来像一个半金字塔:
...
该程序生成一种数字模式，也可称为自然数的半金字塔，如以下快照所示:

![cpp pattern programs](../Images/3723b73f94923f13d510553856b5f85b.png)
...
![cpp pattern programs examples](../Images/32bfb8d841a6f24ca5425ecbc282ca19.png)
...
![pattern programs in cpp](../Images/e60a2f399bff0179cd16f58537b38552.png)
...
![pattern program in c++](../Images/4228296288214b7a585a34e1ddde4cfd.png)
...
![C++ program print star pyramid](../Images/df36d7d1e8e2bf825fed3aeb659f322e.png)

现在提供输入，比如说 **6** 作为打印金字塔图案的行数或行数，金字塔图案有 6 行，如下面给出的快照中的 所示:

![cpp star](../Images/d78bcb80f0f178aa67c61d9521ddbe83.png)

下面是另一个使用用户输入运行的示例， **10** :

![c++ pattern program](../Images/95881ad71caeb9c9d78d70178fccc6f1.png)

#### 其他语言的相同程序

*   [C 模式程序](/c/program/c-program-print-star-pyramid-patterns.htm)
