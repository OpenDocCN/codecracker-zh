...
> 原文:[https://codescracker.com/cpp/cpp-data-structures.htm](https://codescracker.com/cpp/cpp-data-structures.htm)
...
![c++ data structure](../Images/9ef75185c69c3f315f440b172c5201cf.png)
...
![c++ structure definition](../Images/547393285dc409b7626c0c4fe86c7212.png)
![c++ structure initialization](../Images/589ebb13a8d07f876dd5727fd63cd90d.png)
![c++ structure variable definition](../Images/02941e3de4dbe27f5b215bd94ea78b68.png)

输入数据后，如上面的三个示例所示，按 ENTER 键查看年龄超过 60 岁的投票者

![c++ data structure example](../Images/f7a23a016c4e45e047a82defb5b8a8f0.png)
...
![c++ data structure program](../Images/15b056611b4b2fb1e4188cc4c13ff6df.png)
![c++ structure programs](../Images/5ed34f4348ce192fd53de56735398de9.png)
![c++ structure examples](../Images/07c0494decd8833a1a84bfd026a48d31.png)

输入如上所示的数据后，按 y，然后按 ENTER，在屏幕上查看输入的数据，如下图所示:

![data structure c++](../Images/f0d199cc6a5bcdc1698a41d5e2edcfc5.png)
