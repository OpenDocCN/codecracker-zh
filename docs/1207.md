...
5.  [Java 程序寻找两个数中的最大值](/java/program/java-program-find-largest-of-two-numbers.htm)
6.  [Java 程序寻找三个数中的最大值](/java/program/java-program-find-largest-of-three-numbers.htm)
...
24.  [Java 程序计算 nCr 和 nPr](/java/program/java-program-find-ncr-npr.htm)
...
57.  [Java 程序：插入排序](/java/program/java-program-Insertion-sort.htm)
58.  [Java 程序寻找两个数组之间的公共元素](/java/program/java-find-common-elements-from-two-arrays.htm)
59.  [统计数组中偶数和奇数的 Java 程序](/java/program/java-count-even-odd-numbers-in-array.htm)
...
82.  [Java 程序排序字符串](/java/program/java-program-sort-string.htm)
...
86.  [Java 程序检查是否为变位词](/java/program/java-program-check-anagram.htm)
87.  [Java 程序检查对称括号](/java/program/java-check-balanced-parentheses.htm)
